...
add_filter('fl_theme_add_panel_data','cb_customizer_options_filtered', 10, 2 ); 
/**
 ...
 *  @since 2.0.0
 */
function cb_customizer_options_filtered( $data, $key ) {
    if ( 'fl-general' == $key ) {
       ...
       // $data['sections']['fl-body-font-size_mobile']['options']['fl-body-font-size_mobile']['setting']['default']='12';
        ...
        // $data['sections']['fl-buttons']['options']['cb_border-hover']['setting']['default']='#666666';
     ...
     //  $data['sections']['fl-buttons']['options']['cb_border-hover'] = $mynewsetting;
    }
