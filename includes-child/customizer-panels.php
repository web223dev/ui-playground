...
add_action( 'customize_register', 'cb_register_theme_customizer', 20 );
/**
 * Register for the Customizer
 * @since 1.0.0
 */
function cb_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'cb_button_padding_left_right', //give it an ID
			array(
	...
	$wp_customize->add_control(
	   new FLCustomizerControl(
		   $wp_customize,
		   'cb_button_padding_leftright', //give it an ID
			array(
				...
				'settings' => 'cb_button_padding_left_right',                    //pick the setting it applies to
				'priority' => 15,
				'type'     => 'slider',
				'choices'  => array(
					'min'  => 0,
	...
	$wp_customize->add_setting(
		'cb_button_padding_top_bottom', //give it an ID
			array(
	...
	$wp_customize->add_control(
	   new FLCustomizerControl(
		   $wp_customize,
		   'cb_button_padding_topbottom', //give it an ID
			array(
				'label'    => __( 'Button Padding Top/Bottom', 'beavertron' ),   //set the label to appear in the Customizer
				'section'  => 'fl-buttons',                                      //select the section for it to appear under  
				'settings' => 'cb_button_padding_top_bottom',                    //pick the setting it applies to
				'priority' => 15,
				'type'     => 'slider',
				'choices'  => array(
					'min'  => 0,
	 ...
	 */
	$wp_customize->add_setting(
		'cb_woo_additional', //give it an ID
			array(
			'default'   => 'enabled',
		)
	);
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'cb_woo_additional_notes', //give it an ID
			 array (
				'label'       => __( 'WooCommerce Additional Notes', 'beavertron' ),
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_additional',                                                                //pick the setting it applies to
		...
		new WP_Customize_Control(
			...
			'cb_woo_sort', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_sort',                                                                //pick the setting it applies to
		...
		new WP_Customize_Control(
			...
			'cb_woo_results', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_results',                                                                //pick the setting it applies to
		...
		new WP_Customize_Control(
			...
			'cb_woo_sku', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_sku',                                                                //pick the setting it applies to
		...
		new WP_Customize_Control(
			...
			'cb_woo_related', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_related',   //pick the setting it applies to
		...
		new WP_Customize_Control(
			...
			'cb_woo_meta', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_meta',   //pick the setting it applies to
	 ...
	 */
	$wp_customize->add_setting(
		'cb_woo_breadcrumbs', //give it an ID
			array(
			'default'   => 'disabled',
		)
	);
		...
		new WP_Customize_Control(
			...
			'cb_woo_breadcrumbs', //give it an ID
			 array (
				...
				'section'     => 'fl-content-woo',
				'settings'    => 'cb_woo_breadcrumbs',   //pick the setting it applies to
	 ...
	 */
	// Add section.
	$wp_customize->add_section( 'cb_woo_order_section' , array(
		'title'    => __('Order Received Text','beavertron'),
		'panel'    => 'woocommerce',
		'priority' => 10
	) );
	// Add setting
	$wp_customize->add_setting( 'cb_woo_order_received', array(
	...
	$wp_customize->add_control( new WP_Customize_Control(
	    $wp_customize,
		'cb_woo_order_received',
		    array(
		        'label'    => __( 'Order Received Text', 'beavertron' ),
		        'section'  => 'cb_woo_order_section',
		        'settings' => 'cb_woo_order_received',
		        'type'     => 'textarea'
		    )
	    )
	);
	 ...
	 */
	// Add section.
	$wp_customize->add_section( 'cb_woo_vary_dropdown_section' , array(
		'title'    => __('Variation Dropdown Text','beavertron'),
		'panel'    => 'woocommerce',
		'priority' => 10
	) );
	// Add setting
	$wp_customize->add_setting( 'cb_woo_dropdown_variation', array(
	...
	$wp_customize->add_control( new WP_Customize_Control(
	    $wp_customize,
		'cb_woo_dropdown_variation',
		    array(
		        'label'    => __( 'Variation Dropdown Text', 'beavertron' ),
		        'section'  => 'cb_woo_vary_dropdown_section',
		        'settings' => 'cb_woo_dropdown_variation',
		        'type'     => 'textarea'
		    )
	    )
	);
	 ...
	 */
	$wp_customize->add_setting(
		'cb_number_products', //give it an ID
			array(
	...
	$wp_customize->add_control(
		new FLCustomizerControl(
			...
			array(
				...
				'settings' => 'cb_number_products',                    //pick the setting it applies to
				'priority' => 5,
				'type'     => 'slider',
				'choices'  => array(
					'min'  => 0,
	...
	$wp_customize->add_setting( 'cb_woo_tabs_review',
	   array(
	      'default' => 0,
	   )
	);
	 
	$wp_customize->add_control( 'cb_woo_tabs_review',
	   array(
	...
	$wp_customize->add_setting( 'cb_woo_tabs_description',
	   array(
	      'default' => 0,
	   )
	);
	 
	$wp_customize->add_control( 'cb_woo_tabs_description',
	   array(
	...
	$wp_customize->add_setting( 'cb_woo_tabs_information',
	   array(
	      'default' => 0,
	   )
	);
	 
	$wp_customize->add_control( 'cb_woo_tabs_information',
	   array(
	...
	$wp_customize->add_section( 'cb_login_styles' , array(
	...
	$wp_customize->add_setting( 'cb_login_accent_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_custom_accent_color', //give it an ID
		   array(
			   'label'      => __( 'Login accent color', 'beavertron' ), //set the label to appear in the Customizer
			   'section'    => 'cb_login_styles', //select the section for it to appear under  
			   'settings'   => 'cb_login_accent_color' //pick the setting it applies to
		   )
	   )
	);

	$wp_customize->add_setting( 'cb_login_accent_hover_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_custom_accent_hover_color', //give it an ID
			array(
					'label'      => __( 'Login accent hover color', 'beavertron' ), //set the label to appear in the Customizer
					'section'    => 'cb_login_styles', //select the section for it to appear under  
					'settings'   => 'cb_login_accent_hover_color' //pick the setting it applies to
				)
			)
	);

	$wp_customize->add_setting( 'cb_login_link_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_custom_link_color', //give it an ID
			array(
				'label'      => __( 'Login link color', 'beavertron' ), //set the label to appear in the Customizer
				'section'    => 'cb_login_styles', //select the section for it to appear under  
				'settings'   => 'cb_login_link_color' //pick the setting it applies to
			)
		)
	);

	$wp_customize->add_setting( 'cb_login_link_hover_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_custom_link_hover_color', //give it an ID
			array(
				'label'      => __( 'Login link hover color', 'beavertron' ), //set the label to appear in the Customizer
				'section'    => 'cb_login_styles', //select the section for it to appear under  
				'settings'   => 'cb_login_link_hover_color' //pick the setting it applies to
			)
		)
	);

	$wp_customize->add_setting( 'cb_login_background_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_custom_background_color', //give it an ID
			array(
				'label'      => __( 'Login background color', 'beavertron' ), //set the label to appear in the Customizer
				'section'    => 'cb_login_styles', //select the section for it to appear under  
				'settings'   => 'cb_login_background_color' //pick the setting it applies to
			)
		)
	);	

	$wp_customize->add_setting( 'cb_login_form_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_form_color', //give it an ID
			array(
				'label'      => __( 'Login form background color', 'beavertron' ), //set the label to appear in the Customizer
				'section'    => 'cb_login_styles', //select the section for it to appear under  
				'settings'   => 'cb_login_form_color' //pick the setting it applies to
			)
		)
	);

	$wp_customize->add_setting( 'cb_login_form_text', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize,
		'cb_login_form_text', //give it an ID
			array(
				'label'      => __( 'Login form text color', 'beavertron' ), //set the label to appear in the Customizer
				'section'    => 'cb_login_styles', //select the section for it to appear under  
				'settings'   => 'cb_login_form_text' //pick the setting it applies to
			)
		)
	);
	...
	// Add setting.
	$wp_customize->add_setting( 'cb_login_logo', array(
		'default'     => $custom_logo_url,
	) );

	// Add control.
	$wp_customize->add_control( new WP_Customize_Image_Control(
		$wp_customize, 'cb_login_logo', array(
			'label'      => __( 'Add alternative login logo here,', 'beavertron' ),
			'section'    => 'cb_login_styles',
			'settings'   => 'cb_login_logo',
			)
	) );

	$wp_customize->add_setting( 'cb_admin_font',
		array(
		'default' => 0,
		)
	);
	
	$wp_customize->add_control( 'cb_admin_font',
		array(
	...
	// Add section.
	$wp_customize->add_section( 'cb_scripts_section' , array(
		'title'    => __('BB Scripts','beavertron'),
		'panel'    => 'fl-general',
		'priority' => 10
	) );
	
	$wp_customize->add_setting( 'cb_fitvids_script',
	   array(
	      'default' => 0,
	   )
	);
	 
	$wp_customize->add_control( 'cb_fitvids_script',
	   array(
	      'label' => __( 'Remove BB FitVids Script' ),
	      'section' => 'cb_scripts_section',
	      'priority' => 10, // Optional. Order priority to load the control. Default: 10
	      'type' => 'checkbox',
	   )
	);

	$wp_customize->add_setting( 'cb_waypoints_script',
		array(
		'default' => 0,
		)
	);
	
	$wp_customize->add_control( 'cb_waypoints_script',
		array(
	...
	$wp_customize->add_setting( 'cb_throttle_script',
		array(
		'default' => 0,
		)
	);

	$wp_customize->add_control( 'cb_throttle_script',
		array(
	...
	$wp_customize->add_setting( 'cb_imagesloaded_script',
		array(
		'default' => 0,
		)
	);

	$wp_customize->add_control( 'cb_imagesloaded_script',
		array(
	...
	$wp_customize->add_setting( 'cb_magnificpopup_script',
		array(
		'default' => 0,
		)
	);

	$wp_customize->add_control( 'cb_magnificpopup_script',
		array(
	...
	$wp_customize->add_setting( 'cb_magnificpopup_style',
		array(
		'default' => 0,
		)
	);

	$wp_customize->add_control( 'cb_magnificpopup_style',
		array(
	...
	// $wp_customize->remove_section( 'cb_single_image_section' );
...
add_filter( 'fl_default_theme_mods', 'cb_default_theme_preset');
/** 
 *  Set Active Preset Theme Mods
 *  @since 1.0.0
 */
function cb_default_theme_preset( $mods ) {
	$mods2 = array(
		'fl-layout-width'				=> 'full-width',
...
//add_action( 'after_setup_theme', 'cb_add_customizer_panel', 35 );
/**
 * Create Custom Customizer Panel with FLCustomizer::add_panel
 * 7 Panel Examples with a range of controls ... informational
 * @since 1.7.0
 */
function cb_add_customizer_panel() {
    /* Body Background Section */
        FLCustomizer::add_panel('cb_bg_image', array(
