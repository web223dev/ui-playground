...
add_action( 'login_enqueue_scripts', 'cb_css_inline_login', 1009 );
/**
 * Inline Style for login css
 *
 * @since 1.7.1
 */
function cb_css_inline_login() {
	...
	$login_color = get_theme_mod( 'cb_login_accent_color');
	$login_hover_color = get_theme_mod( 'cb_login_accent_hover_color');
	$login_background_color = get_theme_mod( 'cb_login_background_color');
	$login_link_color = get_theme_mod( 'cb_login_link_color');
	$login_link_hover_color = get_theme_mod( 'cb_login_link_hover_color');
	$login_form_color = get_theme_mod( 'cb_login_form_color');
	$login_form_text_color = get_theme_mod( 'cb_login_form_text');
	$login_logo = get_theme_mod( 'cb_login_logo');
...
add_action( 'admin_enqueue_scripts', 'cb_css_inline_admin_common', 1009 );
/**
...
function cb_css_inline_admin_common() {

	$admin_font = get_theme_mod( 'cb_admin_font');
...
add_action( 'admin_enqueue_scripts', 'cb_css_inline_admin_bar', 1009 );
/**
...
function cb_css_inline_admin_bar() {
